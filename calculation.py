...
def calculate(
    p,t,d_p, p_atm, p_unit = 'psi', d_p_unit = 'mbar',                  
    ...
    result = aga3_calculate(p=p,t=t,d_p=d_p, p_unit=p_unit, p_atm=p_atm ,d_p_unit=d_p_unit ,Z_f=z_f,Z_b=z_b, M_gas=molar_mass,d0=d0,D0=D0)
